...
// Ec Id
 ...
 // カテゴリ指定なし（全ジャンル）
  ...
  define('TWITTER_CALLBACK','http://software-instrument.com/callback.php');
  ...
  define('YAHOO_CALLBACK','http://software-instrument.com/ycallback.php');

  // google
  define('GOOGLE_CLIENT_ID', '86987***0521.apps.googleusercontent.com');
  define('GOOGLE_CLIENT_SECRET', '8***P5GnXi2f***_SZQ5X3Ze');
  define('GOOGLE_CALLBACK', 'http://software-instrument.com/oauth2callback.php');
